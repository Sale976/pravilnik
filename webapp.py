    ...
    st.markdown("""
        <style>
            ...
            section[data-testid="stSidebar"] .stButton:nth-of-type(1) button {
                position: fixed;
                top: 15px;        /* 10px od samog vrha stranice */
                left: 50px;       /* 10px od leve ivice ekrana/sidebar-a */
...
st.markdown(
    ...
    <p style='font-size:18px; text-align: left;'>
        🛈 Aplikacija pretražuje tekstualni fajl (gornje levo dugme za prikaz sadržaja) i na osnovu te pretrage prikazuje broj člana i stranu iz PDF verzije pravilnika.
