...
st.write('🛈 Primer načina pretrage: Unosom reči :orange["*svetlo*"] aplikacija vraća više mogućih rezultata, međutim ako se unese :orange["*kratko svetlo*"] dobija se jedan rezultat.')
