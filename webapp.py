...
st.markdown(
    ...
    <p style='font-size:18px; text-align: left;'>
        ...
        🛈 Tekstualni fajl (gornje levo dugme za prikaz sadržaja) je za korisnika aplikacije isključivo informativnog karaktera. Preporučljivo je da korisnik letimično pregleda ovaj fajl!
    </p>
    </h2>
...
st.write('🛈 Primer načina pretrage: Unosom reči npr. :orange["*svetla*"] aplikacija vraća više rezultata iz kojih se može naći odgovarajući rezultat, međutim ako se unese :orange["*kratka svetla*"] dobija se jedan rezultat.')
