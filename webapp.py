...
<div style="display: flex; align-items: center; justify-content: center; gap: 16px; margin-bottom: 10px; margin-top: -20px;">
    <img src="https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https://sale976-pravilnik.streamlit.app&count_bg=%2379C83D&title_bg=%23555555&icon=streamlit.svg&icon_color=%23E7E7E7&title=posete&edge_flat=false"/>
