...
st.markdown(
    ...
    <p style='font-size:18px; text-align: justify;'>
        🛈 Pravilnik o Podeli Vozila, Službeni glasnik RS br. 53 од 20. јуна 2025. | Pravilnik o Tehničkom Pregledu, SG RS br. 62 od 26. маја 2022. 
    </p>
    """,
...
with col2:
    ...
    if st.session_state.search_query:
        ...
        if matching_lines:
            st.markdown(
                "<h3 style='color: #0077b6; margine-top: -15px; font-size: 20px;'>🔍 Rezultati pretrage:</h3>",
                unsafe_allow_html=True
            )
